...
<div id="homepage-form-container" class="homepage-searchbar">
    <form class="homepage-search-form" action="<?php echo home_url(); ?>" role="search" method="get" enctype="application/x-www-form-urlencoded">
        <label class="homepage-search-form-label" for="s"><?php echo nau_trans("Search Courses")?></label>
        <input class="homepage-search-form-input" name="s" type="text" placeholder="<?=nau_trans("What do you want to learn today?")?>" value="<?php echo isset($search_query) ? $search_query : ""; ?>">
