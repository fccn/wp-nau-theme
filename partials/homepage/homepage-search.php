...
<div id="homepage-form-container" class="homepage-searchbar">
    <form class="homepage-search-form" action="<?php echo home_url(); ?>" role="search" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <input class="homepage-search-form-input" name="s" type="search" placeholder="<?=nau_trans("Search Courses")?>" value="<?php echo isset($search_query) ? $search_query : ""; ?>" aria-labelledBy="banner-search-form-label">
